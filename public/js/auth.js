var Auth = {
	vars: {
		...
		closesign: document.getElementById('closesign'),
	...
	loginback(e) {
		...
		setTimeout(() => {
			...
			Auth.vars.password_group.style.marginBottom = 90 + 'px';
		}, 100);
	...
	init(option) {
		...
		Auth.vars.register_link.addEventListener("click", (e) => {
            ...
            document.getElementById("closesign").style.visibility="hidden";
            setTimeout(() => {
                document.getElementById("closesign").style.visibility="visible";
            }, 1000);
		});
        ...
        Auth.vars.closesign.addEventListener("click", (e) => {
           Auth.close(e);
        });
	}
};
function start() {
    ...
    setTimeout(() => {
        document.getElementById("closesign").style.display="inline-block";
        document.getElementById("closesign").style.visibility="visible";
    }, 1000);
    Auth.vars.lowin_login.className += ' lowin-animatedback';
}
